...
def run():
    ...
    if flag_data_type=='text':
        out=transmitter.transmit_data(samples_data,error_corr,pluse_shape)
        flag_data_type='none'
    elif flag_data_type=='numbers':
        out=transmitter.transmit_numbers(samples_data,error_corr,pluse_shape)
        flag_data_type='none'
    elif flag_data_type=='code':
        out=transmitter.transmit_numbers(samples_data,error_corr,pluse_shape)
        flag_data_type='none'
    elif flag_data_type== 'none':
...
def browse_text():
    global file_samples,samples_data,flag_data_type
...
ttk.Label(TAB1,text="Browse Samples File: ").place(x=10,y=53)
