# -*- coding: utf-8 -*-
"""
Created on Sat Feb  1 23:03:18 2020
...
def hamming(d):  # GENERATE HAMMING CODE
    ...
    h.reverse()
    res = "".join(str(x) for x in h) 
    return res

hamming(89)

"""
def hamming_correction(data): # DETECT ERROR IN RECEIVED HAMMING CODE
